...
## [4.4.13](https://github.com/KongHack/Interfaces/releases/tag/4.4.13)
- @GameCharmer Add `HasExceptionContext`



## [4.4.12](https://github.com/KongHack/Interfaces/releases/tag/4.4.12)
- @GameCharmer migrate `CommonEnvironmentEnumInterface` to this repo
...
## [4.3.13](https://github.com/KongHack/Interfaces/releases/tag/4.3.13)
- @GameCharmer Update Composer Dependencies



## [4.3.12](https://github.com/KongHack/Interfaces/releases/tag/4.3.12)
...
## [4.3.9](https://github.com/KongHack/Interfaces/releases/tag/4.3.9)
- @GameCharmer PEX Level Constants



## [4.3.8](https://github.com/KongHack/Interfaces/releases/tag/4.3.8)
- @GameCharmer Patch Name
